# v1.0.3 状态机命令 Implementation Plan
...
- 决策依据：`docs/decisions/26-grill-decisions.md` § v1.0.3（审计 Q7/Q8/Q9 + 实施 Q1-Q11）。
...
- [ ] 更新 `docs/PROJECT_STATUS.md`：把 v1.0.3 CLI 缺口标记为已交付，cursor 移到 v1.0.4。
...
- **范围外**（按决策）：全书仪表盘 `jianwu list`、`--json`、TOC、非 md 导出目标（v1.1.4）、book 包状态机转换表（YAGNI）。
